        ...
        <main className="flex min-h-screen flex-col">
                ...
                <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                    <div className="max-w-3xl">
                        ...
                        <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold font-display text-white mb-6 leading-tight">
                            Explore <span className="text-honey-gold">England</span>
                        </h1>
                        <p className="text-xl md:text-2xl text-white/80 font-medium mb-10 max-w-2xl leading-relaxed">
                            Discover our tailored childminding frameworks and community partnerships expanding across England. Join the movement today.
                        </p>
            ...
            <section className="bg-warm-white py-24 relative overflow-hidden">
                <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
                    <FadeIn>
                        <h2 className="text-3xl font-bold text-deep-green mb-6 font-display">England Rollout Plan</h2>
                        <p className="text-lg text-slate max-w-2xl mx-auto mb-10">
                            We are currently establishing strategic partnerships with local authorities, mosques, and community centres across England to roll out our premium childcare provision model.
                        </p>
                        <Link href="/contact">
