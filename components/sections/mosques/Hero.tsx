...
export function MosqueHero() {
    return (
        <section className="relative bg-soft-peach pt-20 pb-32 overflow-hidden">
            {/* Background Pattern */}
            <div
            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
                <div className="max-w-4xl mx-auto mt-12 md:mt-20 mb-12">
                    <span className="text-deep-green font-accent font-semibold tracking-wider uppercase mb-4 block">
                        Pathway for Mosques & Islamic Centres
                    </span>
                    <h1 className="text-4xl md:text-5xl lg:text-[56px] font-bold text-deep-green leading-tight mb-6">
                        The Missing Pillar of the Modern Mosque.
                    </h1>
                    <p className="text-lg md:text-xl text-slate max-w-2xl mx-auto leading-relaxed mb-8">
                        Your spaces are empty from 9am to 3pm. Your community’s children are elsewhere. Little Oaks structures a regulated, income-generating partnership that brings them back.
                    </p>
                    <div className="flex flex-col sm:flex-row gap-4 justify-center">
                        <Link href="/contact">
                            <Button size="lg">Book Strategic Consultation</Button>
                        </Link>
                        <Link href="#calculator">
                            <Button variant="secondary" size="lg">Calculate Rental Income</Button>
                        </Link>
                    </div>
                </div>
            </div>
